...
namespace FMETP
{
    ...
    public class TextureEncoder_Editor : UnityEditor.Editor
    {
        ...
        SerializedProperty typeDataProp;
        ...
        private void OnEnable()
        {
            ...
            typeDataProp = serializedObject.FindProperty("typeData");
            ...
            {
                {
                    ...
                    //This was custom made by Kevin Tjandra
                    GUILayout.BeginHorizontal();
                    EditorGUILayout.PropertyField(typeDataProp, new GUIContent("Type Data"));
                    GUILayout.EndHorizontal();
                }
