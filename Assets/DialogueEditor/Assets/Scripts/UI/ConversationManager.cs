...
namespace DialogueEditor
{
    public class ConversationManager : MonoBehaviour
    {
        ...
        public void EndConversation()
        {
            ...
            // Destroy the Conversation Canvas after transition
            StartCoroutine(DestroyCanvasAfterTransition());
        }

        private IEnumerator DestroyCanvasAfterTransition()
        {
            yield return new WaitForSeconds(TRANSITION_TIME); // Wait for the transition to finish
            Destroy(gameObject); // Destroy the Conversation Canvas GameObject
        }
