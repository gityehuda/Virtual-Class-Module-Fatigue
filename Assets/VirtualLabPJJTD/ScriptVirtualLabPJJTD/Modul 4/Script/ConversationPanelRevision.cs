...
[System.Serializable]
public class DialogueRevision
{
    public string name;           // Optional name for the dialogue
    public GameObject[] panels;   // Array of panels for this dialogue
}

public class ConversationPanelRevision : MonoBehaviour
{
    public static ConversationPanelRevision instance;

    public DialogueRevision[] dialogues;     // Array of dialogues
    public DialogueRevision[] conversationAfterTutorial; // Array of dialogues after DummyAntro is destroyed
    public DialogueRevision[] conversationWhenKursiGuruAppears; // Array of dialogues when KursiGuru appears
