...
public class Module4Evaluation : MonoBehaviour
{
    ...
    {
        if (conversationPanel.currentDialogueIndex == 1 || conversationPanel.currentDialogueIndex == 2 || conversationPanel.currentDialogueIndex == 3)
        {
        ...
        if (conversationPanel.currentDialogueIndex == 2)
        {
            if (module4UImanager2.simTableErgo.activeSelf == true)
            {
                if (simQuestion.isCheck1 == false)
                {
                    ...
                    InputMaleErgo.transform.GetChild(0).GetChild(0).GetChild(2).GetComponent<TMP_Text>().color = Color.red;
                ...
                if (simQuestion.isCheck2 == false)
                {
                    ...
                    InputMaleErgo.transform.GetChild(1).GetChild(0).GetChild(2).GetComponent<TMP_Text>().color = Color.red; 
                ...
                if (simQuestion.isCheck3 == false)
                {
                    ...
                    InputMaleErgo.transform.GetChild(2).GetChild(0).GetChild(2).GetComponent<TMP_Text>().color = Color.red;     
                ...
                if (simQuestion.isCheck4 == false)
                {
                    ...
                    InputFemaleErgo.transform.GetChild(0).GetChild(0).GetChild(2).GetComponent<TMP_Text>().color = Color.red;
                ...
                if (simQuestion.isCheck5 == false)
                {
                    ...
                    InputFemaleErgo.transform.GetChild(1).GetChild(0).GetChild(2).GetComponent<TMP_Text>().color = Color.red;
                ...
                if (simQuestion.isCheck6 == false)
                {
                    ...
                    InputFemaleErgo.transform.GetChild(2).GetChild(0).GetChild(2).GetComponent<TMP_Text>().color = Color.red;
                ...
                if (simQuestion.isCheck7 == false)
                {
                    ...
                    InputMaleErgo.transform.GetChild(3).GetChild(0).GetChild(2).GetComponent<TMP_Text>().color = Color.red; 
                ...
                if (simQuestion.isCheck8 == false)
                {
                    ...
                    InputFemaleErgo.transform.GetChild(3).GetChild(0).GetChild(2).GetComponent<TMP_Text>().color = Color.red;       
            ...
            if (module4UImanager2.simTableFootstep.activeSelf == true)
            {
                if (simQuestion.isCheck9 == false)
                {
                    ...
                    InputFootstepMale.transform.GetChild(0).GetChild(0).GetChild(2).GetComponent<TMP_Text>().color = Color.red;
                ...
                if (simQuestion.isCheck10 == false)
                {
                    ...
                    InputFootstepMale.transform.GetChild(1).GetChild(0).GetChild(2).GetComponent<TMP_Text>().color = Color.red; 
                ...
                if (simQuestion.isCheck11 == false)
                {
                    ...
                    InputFootstepMale.transform.GetChild(2).GetChild(0).GetChild(2).GetComponent<TMP_Text>().color = Color.red;     
                ...
                if (simQuestion.isCheck12 == false)
                {
                    ...
                    InputFootstepFemale.transform.GetChild(0).GetChild(0).GetChild(2).GetComponent<TMP_Text>().color = Color.red;   
                ...
                if (simQuestion.isCheck13 == false)
                {
                    ...
                    InputFootstepFemale.transform.GetChild(1).GetChild(0).GetChild(2).GetComponent<TMP_Text>().color = Color.red;
                ...
                if (simQuestion.isCheck14 == false)
                {
                    ...
                    InputFootstepFemale.transform.GetChild(2).GetChild(0).GetChild(2).GetComponent<TMP_Text>().color = Color.red;   
                ...
                if (simQuestion.isCheck15 == false)
                {
                    ...
                    InputFootstepMale.transform.GetChild(3).GetChild(0).GetChild(2).GetComponent<TMP_Text>().color = Color.red; 
                ...
                if (simQuestion.isCheck16 == false)
                {
                    ...
                    InputFootstepFemale.transform.GetChild(3).GetChild(0).GetChild(2).GetComponent<TMP_Text>().color = Color.red;       
            ...
            if (module4UImanager2.simTableErgoMale.activeSelf == true)
            {
                ...
                if (simQuestion.isCheck17 == false)
                {
                    ...
                    InputMale.transform.GetChild(0).GetChild(0).GetChild(2).GetComponent<TMP_Text>().color = Color.red; 
                    evaluationText.text = "3.43";
                    correctInputMale[0].SetActive(true);
                }
                if (simQuestion.isCheck18 == false)
                {
                    ...
                    InputMale.transform.GetChild(1).GetChild(0).GetChild(2).GetComponent<TMP_Text>().color = Color.red; 
                    evaluationTextESession2.text = " 4.13";
                    correctInputMale[1].SetActive(true);
                }
                if (simQuestion.isCheck19 == false)
                {
                    ...
                    InputMale.transform.GetChild(2).GetChild(0).GetChild(2).GetComponent<TMP_Text>().color = Color.red;
                    evaluationTextESession3.text = " 5.43";
                    correctInputMale[2].SetActive(true);
                }
                if (simQuestion.isCheck20 == false)
                {
                    ...
                    InputMale.transform.GetChild(3).GetChild(0).GetChild(2).GetComponent<TMP_Text>().color = Color.red; 
                    evaluationTextESession4.text = " 4.33";
                    correctInputMale[3].SetActive(true);
                }
            ...
            if (module4UImanager2.simTableErgoFemale.activeSelf == true)
            {
                if (simQuestion.isCheck21 == false)
                {
                    ...
                    InputFemale.transform.GetChild(0).GetChild(0).GetChild(2).GetComponent<TMP_Text>().color = Color.red;   
                ...
                if (simQuestion.isCheck22 == false)
                {
                    ...
                    InputFemale.transform.GetChild(1).GetChild(0).GetChild(2).GetComponent<TMP_Text>().color = Color.red;   
                ...
                if (simQuestion.isCheck23 == false)
                {
                    ...
                    InputFemale.transform.GetChild(2).GetChild(0).GetChild(2).GetComponent<TMP_Text>().color = Color.red;   
                ...
                if (simQuestion.isCheck24 == false)
                {
                    ...
                    InputFemale.transform.GetChild(3).GetChild(0).GetChild(2).GetComponent<TMP_Text>().color = Color.red;                       
            ...
            if (module4UImanager2.simTableFootstepMale.activeSelf == true)
            {
                if (simQuestion.isCheck25 == false)
                {
                    ...
                    InputMaleFootstep.transform.GetChild(0).GetChild(0).GetChild(2).GetComponent<TMP_Text>().color = Color.red; 
                    correctInputMale[0].SetActive(true);
                }
                if (simQuestion.isCheck26 == false)
                {
                    ...
                    InputMaleFootstep.transform.GetChild(1).GetChild(0).GetChild(2).GetComponent<TMP_Text>().color = Color.red; 
                    correctInputMale[1].SetActive(true);
                }
                if (simQuestion.isCheck27 == false)
                {
                    ...
                    InputMaleFootstep.transform.GetChild(2).GetChild(0).GetChild(2).GetComponent<TMP_Text>().color = Color.red;
                    correctInputMale[2].SetActive(true);
                }
                if (simQuestion.isCheck28 == false)
                {
                    ...
                    InputMaleFootstep.transform.GetChild(3).GetChild(0).GetChild(2).GetComponent<TMP_Text>().color = Color.red;     
                    correctInputMale[3].SetActive(true);
                }
            }
            if (module4UImanager2.simTableFootstepFemale.activeSelf == true)
            {
                if (simQuestion.isCheck29 == false)
                {
                    ...
                    InputFemaleFootstep.transform.GetChild(0).GetChild(0).GetChild(2).GetComponent<TMP_Text>().color = Color.red;   
                    correctInputFemale[0].SetActive(true);
                }
                if (simQuestion.isCheck30 == false)
                {
                    ...
                    InputFemaleFootstep.transform.GetChild(1).GetChild(0).GetChild(2).GetComponent<TMP_Text>().color = Color.red;   
                    correctInputFemale[1].SetActive(true);
                }
                if (simQuestion.isCheck31 == false)
                {
                    ...
                    InputFemaleFootstep.transform.GetChild(2).GetChild(0).GetChild(2).GetComponent<TMP_Text>().color = Color.red;       
                    correctInputFemale[2].SetActive(true);
                }
                if (simQuestion.isCheck32 == false)
                {
                    ...
                    InputFemaleFootstep.transform.GetChild(3).GetChild(0).GetChild(2).GetComponent<TMP_Text>().color = Color.red;
                    correctInputFemale[3].SetActive(true);
                }
            ...
            if (module4UImanager2.RTableErgoMale.activeSelf == true)
            {
                ...
                conversationPanel.dialogues[2].panels[conversationPanel.currentPanelIndex].transform.GetChild(3).GetChild(0).GetComponent<TMP_Text>().color = new Color(0f, 0.7075f, 0f);
            }
            if (module4UImanager2.RTableErgoFemale.activeSelf == true)
            {
                ...
                conversationPanel.dialogues[2].panels[conversationPanel.currentPanelIndex].transform.GetChild(5).GetChild(0).GetComponent<TMP_Text>().color = new Color(0, 0.7075f, 0);
            }
            if (module4UImanager2.RTableFootstepMale.activeSelf == true)
            {
                ...
                conversationPanel.dialogues[2].panels[conversationPanel.currentPanelIndex].transform.GetChild(3).GetChild(0).GetComponent<TMP_Text>().color = new Color(0, 0.7075f, 0);
            }
